  ...
  $("#viewSettings").innerHTML = `
    ...
    <div class="sgrid">
      ...
      <section class="scard">
        ...
        <p><b>Optional and not needed for the included profiles.</b> Arrows, digits, Pg+/Pg-, DEL and Menu reach Windows as ordinary keyboard keys, so Airdeck leaves them working normally. Remapping them on the remote only needs the Interception driver, which only works after a Windows restart and stops a receiver's keys if it is re-plugged later (until the next restart).</p>
